...
class Menu :
    ...
    def __init__(self, application, *groupes) :
        ...
        items = (
            ...
            ('COMMENT JOUER ?', application.comment_jouer),
            ('COMMANDES', application.jeu),
...
class Application :
    ...
    def __init__(self) :
        pygame.init()
        pygame.display.set_caption("Pringles Fight")

        self.fond = (150,)*3

        self.fenetre = pygame.display.set_mode((surfaceW,surfaceH), pygame.FULLSCREEN)
